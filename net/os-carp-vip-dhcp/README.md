...
📖 **Full documentation lives on the project landing page → [repository README](../../README.md)** — what it does, when you need it, getting started, the GUI, how it works, all options, ISP-security notes, and the single-IP design.
